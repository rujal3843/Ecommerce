    ...
    <div className=''>
      {data && (
        <div key={data.id} className="grid grid-cols-1 sm:grid-cols-2 gap-8">
          <img src={data.images} alt="" className="h-[540px] mx-auto mt-5 shadow-2xl hover:scale-105 transition-transform duration-300 cursor-pointer" />

          <div className="p-5 border border-gray-300 rounded-lg shadow-lg">
            <h1 className="text-2xl font-bold mb-4">{data.title}</h1>
            <p className="text-lg font-bold mb-3">Price: ${data.price}</p>
            ...
            <p className="mt-2">Category: {data.category.name}</p>
